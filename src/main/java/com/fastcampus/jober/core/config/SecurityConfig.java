package com.fastcampus.jober.core.config;

import com.fastcampus.jober.core.auth.jwt.JwtAuthenticationFilter;
import com.fastcampus.jober.core.exception.Exception401;
import com.fastcampus.jober.core.exception.Exception403;
import com.fastcampus.jober.core.utils.FilterResponseUtils;
...
import static com.fastcampus.jober.core.exception.ErrorCode.INVALID_USER;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        ...
        // 9. 권한 실패 처리
        http.exceptionHandling(c -> c.accessDeniedHandler((request, response, accessDeniedException) -> {

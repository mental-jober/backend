...
public class SpaceWallTemp {
    ...
    @JoinColumn(name = "layout_id", nullable = true) // 임시 저장에서는 nullable 처리
    private SpaceWallLayout layout;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "create_member_id", nullable = true) // 임시 저장에서는 nullable 처리
    private Member createMember;

    @ManyToOne(fetch = FetchType.LAZY)
    @JoinColumn(name = "workspace_id", nullable = true) // 임시 저장에서는 nullable 처리

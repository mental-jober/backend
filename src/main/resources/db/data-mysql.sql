...
INSERT INTO member (email, password, username, created_at) VALUES ('member1@gmail.com', 'apaqj11!', '멤버1', now());
...
VALUES (1, 'https://dummy-url-1.com', 'Dummy Title 1', 'Dummy Description 1', 'https://dummy-profile-image-1.com', 'https://dummy-bg-image-1.com', 'https://dummy-share-url-1.com', DATE_ADD(NOW(), INTERVAL 10 DAY), 1, now());
INSERT INTO space_wall_member (member_id, space_wall_id, created_at) VALUES (1, 1, now()); -- OWNER 1
INSERT INTO space_wall_permission (space_wall_member_id, auths, created_at) VALUES (1, 'OWNER', now());

INSERT INTO member (email, password, username, created_at) VALUES ('member2@gmail.com', 'apaqj11!', '멤버2', now());
INSERT INTO space_wall (create_member_id, url, title, description, profile_image_url, background_image_url, share_url, share_expired_at, sequence, created_at)
VALUES (2, 'https://dummy-url-2.com', 'Dummy Title 2', 'Dummy Description 2', 'https://dummy-profile-image-2.com', 'https://dummy-bg-image-2.com', 'https://dummy-share-url-2.com', DATE_ADD(NOW(), INTERVAL 5 DAY), 1, now());
INSERT INTO space_wall_member (member_id, space_wall_id, created_at) VALUES (2, 2, now()); -- OWNER 1
INSERT INTO space_wall_permission (space_wall_member_id, auths, created_at) VALUES (2, 'OWNER', now());

INSERT INTO member (email, password, username, created_at) VALUES ('member3@gmail.com', 'apaqj11!', '멤버3', now());
INSERT INTO space_wall (create_member_id, url, title, description, profile_image_url, background_image_url, share_url, share_expired_at, sequence, created_at)
VALUES (3, 'https://dummy-url-3.com', 'Dummy Title 3', 'Dummy Description 3', 'https://dummy-profile-image-3.com', 'https://dummy-bg-image-3.com', 'https://dummy-share-url-3.com', DATE_ADD(NOW(), INTERVAL 3 DAY), 1, now());
INSERT INTO space_wall_member (member_id, space_wall_id, created_at) VALUES (3, 3, now()); -- OWNER 1
INSERT INTO space_wall_permission (space_wall_member_id, auths, created_at) VALUES (3, 'OWNER', now());

INSERT INTO member (email, password, username, created_at) VALUES ('member4@gmail.com', 'apaqj11!', '멤버4', now());
INSERT INTO space_wall (create_member_id, url, title, description, profile_image_url, background_image_url, share_url, share_expired_at, sequence, created_at)
VALUES (4, 'https://dummy-url-4.com', 'Dummy Title 4', 'Dummy Description 4', 'https://dummy-profile-image-4.com', 'https://dummy-bg-image-4.com', 'https://dummy-share-url-4.com', DATE_ADD(NOW(), INTERVAL 3 DAY), 1, now());
INSERT INTO space_wall_member (member_id, space_wall_id, created_at) VALUES (4, 4, now()); -- OWNER 1
INSERT INTO space_wall_permission (space_wall_member_id, auths, created_at) VALUES (4, 'OWNER', now());
...
VALUES (1, null, 'text', true, '텍스트 타입 입니다. <br>', 1, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (1, null, 'line', true, '구분선 타입 입니다.', 2, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (1, 1, 'template', true, '템플릿 타입 입니다.', 3, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (1, null, 'page', true, '페이지 타입 입니다', 4, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (1, null, 'page', false, '페이지 타입 입니다', 5, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (1, null, 'link', true, '링크 타입 입니다.', 6, now());

-- Component (space_wall_id = 2) --
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (2, null, 'text', true, '텍스트 타입 입니다. <br>', 1, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (2, null, 'line', true, '구분선 타입 입니다.', 2, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (2, 2, 'template', true, '템플릿2 타입 입니다.', 3, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (2, null, 'page', true, '페이지 타입 입니다', 4, now());
INSERT INTO component (space_wall_id, template_id, type, visible, content, sequence, created_at)
VALUES (2, null, 'link', true, '링크 타입 입니다.', 5, now());
...
VALUES (1, 'https://url-11.com', 'Title 11 임시', 'Description 11 임시', 'https://profile-image-11.com', 'https://bg-image-11.com', 'https://share-url-11.com', DATE_ADD(NOW(), INTERVAL 10 DAY), 1, NOW());
INSERT INTO space_wall_temp (space_wall_id, url, title, description, profile_image_url, background_image_url, share_url, share_expired_at, sequence, created_at)
VALUES (2, 'https://url-22.com', 'Title 22 임시', 'Description 22 임시', 'https://profile-image-22.com', 'https://bg-image-22.com', 'https://share-url-22.com', DATE_ADD(NOW(), INTERVAL 5 DAY), 2, NOW());
INSERT INTO space_wall_temp (space_wall_id, url, title, description, profile_image_url, background_image_url, share_url, share_expired_at, sequence, created_at)
VALUES (3, 'https://url-33.com', 'Title 33 임시', 'Description 33 임시', 'https://profile-image-33.com', 'https://bg-image-33.com', 'https://share-url-33.com', DATE_ADD(NOW(), INTERVAL 3 DAY), 3, NOW());